...
hg_entities = pickle.load(open('FB13_hg_entities.pkl', 'rb'))
# {level: [relation, rid, relationid2embeds[eid]}, relationid2embeds[eid] is generated by T5-small
hg_relations = pickle.load(open('FB13_hg_relations.pkl', 'rb'))
...
def create_hyper_triplets():
    ...
    pickle.dump(triplets, open('FB13_new_hg_triplets.pkl', 'wb'))
    triplets = pickle.load(open('FB13_new_hg_triplets.pkl', 'rb'))

    # # load old train file and add them to the hyper triplets
    # original_train_data_file = '../knowledge_graph_tasks/embedding_based/benchmarks/FB13/org_train2id.txt'
    ...
    # train_data_file = '../knowledge_graph_tasks/embedding_based/benchmarks/FB13/train2id.txt'
