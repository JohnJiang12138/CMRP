...
api_key = 'sk-qZkhJ7fcoqw2n9gkB133Bd849e2c461aB63b0dD746444d0d'
...
def call_llm_api(prompt, max_retries=10, timeout=10):
    ...
    for _ in range(max_retries):
        try:
            response = requests.post('https://d2.xiamoai.top/v1/chat/completions', headers=headers, json=data, timeout=timeout)
