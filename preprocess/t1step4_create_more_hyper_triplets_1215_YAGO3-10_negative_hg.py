...
hg_entities = pickle.load(open('YAGO3-10_hg_entities_negative_samples.pkl', 'rb'))
# {level: [relation, rid, relationid2embeds[eid]}, relationid2embeds[eid] is generated by T5-small
hg_relations = pickle.load(open('YAGO3-10_hg_relations_negative_samples.pkl', 'rb'))
...
def create_hyper_triplets():
    ...
    pickle.dump(triplets, open('YAGO3-10_new_hg_triplets_negative_samples.pkl', 'wb'))
    #pickle.dump(ent2q, open('YAGO3-10_new_q2ent_triplets_negative_samples.pkl', 'wb'))
    triplets = pickle.load(open('YAGO3-10_new_hg_triplets_negative_samples.pkl', 'rb'))

    # load old train file and add them to the hyper triplets
    original_train_data_file = '../knowledge_graph_tasks/embedding_based/benchmarks/YAGO3-10/org_train2id.txt'
    ...
    train_data_file = '../knowledge_graph_tasks/embedding_based/benchmarks/YAGO3-10/train2id.txt'
