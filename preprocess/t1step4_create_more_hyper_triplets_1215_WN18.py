...
hg_entities = pickle.load(open('WN18_hg_entities.pkl', 'rb'))
# {level: [relation, rid, relationid2embeds[eid]}, relationid2embeds[eid] is generated by T5-small
hg_relations = pickle.load(open('WN18_hg_relations.pkl', 'rb'))
...
def create_hyper_triplets():
    ...
    pickle.dump(triplets, open('WN18_new_hg_triplets.pkl', 'wb'))
    pickle.dump(ent2q, open('../REINFORCE/WN18_new_ent2q_triplets.pkl', 'wb'))
    # triplets = pickle.load(open('WN18_new_hg_triplets.pkl', 'rb'))
